# Add `~/bin` to the `$PATH`
export PATH="/usr/local/bin:/usr/local/gnubin:$HOME/bin:$PATH";

# Load the shell dotfiles, and then some:
# * ~/.path can be used to extend `$PATH`.
# * ~/.extra can be used for other settings you don’t want to commit.
for file in ~/.{path,bash_prompt,exports,aliases,functions,extra,venv_profile,openstack_profile,gcp_profile}; do
